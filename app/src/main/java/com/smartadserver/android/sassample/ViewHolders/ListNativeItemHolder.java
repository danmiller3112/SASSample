...
public class ListNativeItemHolder extends RecyclerView.ViewHolder {
    ...
    public ListNativeItemHolder(View itemView) {
        super(itemView);
        textViewIndex = (TextView) itemView.findViewById(R.id.tv_index);
        textViewTitle = (TextView) itemView.findViewById(R.id.tv_title);
        textViewSubtitle = (TextView) itemView.findViewById(R.id.tv_subtitle);
        posterImageView = (ImageView)itemView.findViewById(R.id.poster_image);
        button = (Button)itemView.findViewById(R.id.tv_button);
